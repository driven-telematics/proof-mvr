...
// The functions never directly reference this file. I wish I could reference this one file; however, ever function is in it's own complete directory / environment and can't access this folder. The best solution I have found is to simply make changes to this file and then copy it over to each folder. 
...
export const schemas = {
  ...
  addMvrData: {
    ...
    sex: { // I'm not sure if it is allowed to have Other. Some states allow M, F, or X. This may need some editting for allowOther
      required: true,
      allowEmpty: false,
      allowOther: false,
      type: 'string' as const
